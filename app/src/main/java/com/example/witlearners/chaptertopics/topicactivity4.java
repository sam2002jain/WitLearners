...
public class topicactivity4 extends AppCompatActivity {
    Toolbar toolbar;
    expandableheigthgridview gridView;

    String message = "hello sanyam";

    String topicname[] = {"Unit1_OS", "Unit2_OS", "Unit3_OS", "Unit4_OS", "Unit5_OS", "Unit6_OS#"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_topicactivity4);
        ...
        topicAdapter adapter = new topicAdapter(topicname, topicactivity4.this);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (pdfFileName != null) {
                    ...
                    Toast.makeText(topicactivity4.this, "PDF file not found", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void initializeChapterToPDFMap() {
        ...
        chapterToPDFMap.put("Unit1_OS", "OS_Full_Notes.pdf");
        chapterToPDFMap.put("Unit2_OS", "Unit - 5 Notes.pdf");
    ...
    private void openPDF(String fileName) {
        storageReference.child(fileName).getDownloadUrl().addOnSuccessListener(uri -> {
            ...
            // Handle any errors
            Toast.makeText(topicactivity4.this, "Failed to open PDF", Toast.LENGTH_SHORT).show();
        });
    }
}
